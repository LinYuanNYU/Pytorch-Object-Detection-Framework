...
retinanet_args.add_argument("--dataset_root", default='datas/trashV2',help='Directory path where stores the data in VOC format')
...
ssd_args.add_argument('--dataset_root', default='datas/trashV2',
...
ssd_args.add_argument('--cuda', default=True,
