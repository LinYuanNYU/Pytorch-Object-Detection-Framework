...
from datas.vocDataSet import VOCAnnotationTransform, VOCDetection, BaseTransform
from datas.vocDataSet import VOC_CLASSES as labelmap
...
parser.add_argument('--voc_root', default="datas/trashV2",
